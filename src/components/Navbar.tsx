        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://github.com/mohdmaazkhangkp" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
                <Github className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/in/mohdmaazkhangkp" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-gray-900">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="mailto:mohdmaazkhangkp@gmail.com" className="text-gray-700 hover:text-gray-900">
